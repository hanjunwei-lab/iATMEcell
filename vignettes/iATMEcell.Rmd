...
###<font face="微软雅黑">  Example 1 : Calculate the DEscore, constructing network and randomization. </font>
...
###<font face="微软雅黑">  Example 2 : Constructing the cox risk regression model with cell marker genes. </font>
