...
#' @param exampleData  A character, should be one of"GEP","clinicaldata", "Condition.label"
...
GetExampleSet<-function(exampleData){
  ...
  if (exampleData=="Condition.label")
  {
    dataset<- get("Condition.label",envir=envData)
    return(dataset)
  }
