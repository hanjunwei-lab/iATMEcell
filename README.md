...
library(iATMEcell)
```
# Example 1: Calculate the DEscore, constructing network and randomization
...
```
# Example 2: Constructing the cox risk regression model with cell marker genes
...
library(survival)
#Run the function
R.result<-RiskRegressModel(cellname='NK cells',ExpData=GEP,clinical=clinicaldata,p.cutoff=0.05)
```
# Visualize 1: Draw a forest plot
...
```
# Visualize 2: Draw a Kaplan-Meier curve
...
```
# Visualize 4: Draw a split violin plot
